...
var cliGO = function () { return __awaiter(_this, void 0, void 0, function () {
    var puzInput, total, _a, puzInput_1, puzInput_1_1, line, rowVal, e_1_1;
    var _b, e_1, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                puzInput = getPuzzleInput();
                total = 0;
                _e.label = 1;
            case 1:
                _e.trys.push([1, 6, 7, 12]);
                _a = true, puzInput_1 = __asyncValues(puzInput);
                _e.label = 2;
            case 2: return [4 /*yield*/, puzInput_1.next()];
            case 3:
                if (!(puzInput_1_1 = _e.sent(), _b = puzInput_1_1.done, !_b)) return [3 /*break*/, 5];
                _d = puzInput_1_1.value;
                _a = false;
                line = _d;
                rowVal = getDigits(line);
                total += rowVal;
                console.log(total);
                _e.label = 4;
            case 4:
            ...
            case 7:
                ...
                if (!(!_a && !_b && (_c = puzInput_1.return))) return [3 /*break*/, 9];
                return [4 /*yield*/, _c.call(puzInput_1)];
            case 8:
                _e.sent();
                _e.label = 9;
...
var getDigits = function (line) {
    var searchArr = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"];
    var start = 9999999;
    var end = -1;
    var startNum = "";
    var endNum = "";
    for (var _i = 0, searchArr_1 = searchArr; _i < searchArr_1.length; _i++) {
        var num = searchArr_1[_i];
        if (line.indexOf(num) !== -1) {
            if (line.indexOf(num) < start) {
                start = line.indexOf(num);
                startNum = num;
            }
            if (line.indexOf(num) > end) {
                end = line.indexOf(num);
                endNum = num;
            }
        }
    }
    var numb = startNum + endNum;
    console.log(numb);
    return parseInt(numb);
};
var getPuzTest = function () {
    return ["1abc2", "pqr3stu8vwx", "a1b2c3d4e5f", "treb7uchet"];
};
var getPuzzleInput = function () {
    return [
        "9eightone",
